...
class RemoteTrustPaymentsTest < Test::Unit::TestCase
  def setup
    @gateway = TrustPaymentsGateway.new(fixtures(:trust_payments))
  ...
  def test_invalid_login
    gateway = TrustPaymentsGateway.new(login: '', password: '')
